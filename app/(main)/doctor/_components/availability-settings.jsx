      ...
      <CardContent>
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-emerald-900/10 rounded-md">
          ...
          <p className="text-muted-foreground text-sm">
            By setting your daily availability, you enable patients to schedule appointments within those time frames. This availability is consistent across all days. Feel free to adjust your availability as needed, without impacting previously scheduled appointments.
          </p>
        </div>
      </CardContent>
    </Card>
