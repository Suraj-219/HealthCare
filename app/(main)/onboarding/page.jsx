      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <Button
              className="w-full mt-2 bg-gradient-to-r from-[#fda4af] to-[#fef2f2] hover:from-[#fef2f2] hover:to-[#fda4af]"
              disabled={loading}
            >
              {loading ? (
                <>
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <CardDescription className="mb-4">
              Generate your professional profile, set your availability, and provide consultations
            </CardDescription>
            <Button
              className="w-full mt-2 bg-gradient-to-r from-[#fda4af] to-[#fef2f2] hover:from-[#fef2f2] hover:to-[#fda4af]"
              disabled={loading}
    ...
    return (
      <Card className="border-emerald-900/20">
        <CardContent className="pt-6">
          <div className="mb-6">
            <CardTitle className="text-3xl font-bold mb-2 text-center text-green-500" style={{ textShadow: '1px 1px 2px #fff' }}>
